...
var _Identity2 = /*#__PURE__*/_interopRequireDefault(_Identity);
...
var lensTraverse = function lensTraverse(of) {
  return (0, _ramda.curry)(function (toFunctorFn, target) {
    return _Identity2.default.of((0, _ramda.traverse)(of, (0, _ramda.pipe)(toFunctorFn, (0, _ramda.prop)('value')), target));
  });
};

exports.default = lensTraverse;