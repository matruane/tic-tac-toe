...
var _list2 = /*#__PURE__*/_interopRequireDefault(_list);

var _isTruthy = /*#__PURE__*/require('./isTruthy');

var _isTruthy2 = /*#__PURE__*/_interopRequireDefault(_isTruthy);
 ...
 */
exports.default = /*#__PURE__*/(0, _ramda.curry)(function (combiningPredicate, predicates) {
  return (0, _ramda.useWith)((0, _ramda.compose)(combiningPredicate(_isTruthy2.default), _list2.default), predicates);
});